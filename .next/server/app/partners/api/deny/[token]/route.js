"use strict";(()=>{var t={};t.id=8390,t.ids=[8390],t.modules={20399:t=>{t.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:t=>{t.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6005:t=>{t.exports=require("node:crypto")},53384:(t,e,a)=>{a.r(e),a.d(e,{originalPathname:()=>b,patchFetch:()=>v,requestAsyncStorage:()=>u,routeModule:()=>y,serverHooks:()=>x,staticGenerationAsyncStorage:()=>f});var r={};a.r(r),a.d(r,{GET:()=>g,POST:()=>h});var n=a(49303),o=a(88716),i=a(60670),s=a(87070),d=a(14317),p=a(28218),l=a(7411),c=a(39026);function m(t){return new s.NextResponse(`<!DOCTYPE html>
<html>
...
<body><div class="card">${t}</div></body>
</html>`,{status:200,headers:{"Content-Type":"text/html"}})}async function g(t,{params:e}){let{token:a}=e,r=(0,d.G)(),{data:n}=await r.from("leads").select("id, prospect_company_name").eq("approval_token",a).eq("status","pending").single();return n?m(`
    <h1>Deny Lead</h1>
    <p style="margin-bottom:16px;"><strong>${n.prospect_company_name}</strong></p>
    <form method="POST">
  ...
  `):m(`
    ...
    `)}async function h(t,{params:e}){let{token:a}=e,r=(0,d.G)(),n=(await t.formData()).get("reason")||"",{data:o}=await r.from("leads").select("id, organization_id, prospect_company_name").eq("approval_token",a).eq("status","pending").single();if(!o)return m(`
      <div style="font-size:48px;margin-bottom:16px;">❌</div>
      <h1>Invalid or Expired Link</h1>
      <p>This link has already been used or has expired.</p>
    `);await r.from("leads").update({status:"denied",denial_reason:n||null,approval_token:null,updated_at:new Date().toISOString()}).eq("id",o.id),await (0,p.A)({action:"DENY_LEAD",targetType:"lead",targetId:o.id,metadata:{reason:n,via:"email_link"}}),await r.from("lead_activity").insert({lead_id:o.id,author_type:"apaly_team",content:`Lead denied via email.${n?` Reason: ${n}`:""}`,activity_type:"status_change"});let{data:i}=await r.from("partner_organizations").select("notification_email, company_name").eq("id",o.organization_id).single();if(i?.notification_email){let t=(0,c.wA)({companyName:o.prospect_company_name,partnerContactName:i.company_name,reason:n});await (0,l.C)({to:i.notification_email,subject:t.subject,html:t.html}).catch(console.error)}return m(`
    <div style="font-size:48px;margin-bottom:16px;">✓</div>
    <h1>Lead Denied</h1>
    <p>${o.prospect_company_name} has been denied.${n?` Reason: ${n}`:""}</p>
  `)}let y=new n.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/partners/api/deny/[token]/route",pathname:"/partners/api/deny/[token]",filename:"route",bundlePath:"app/partners/api/deny/[token]/route"},resolvedPagePath:"C:\\Projects\\apalyrx\\src\\app\\partners\\api\\deny\\[token]\\route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:u,staticGenerationAsyncStorage:f,serverHooks:x}=y,b="/partners/api/deny/[token]/route";function v(){return(0,i.patchFetch)({serverHooks:x,staticGenerationAsyncStorage:f})}},28218:(t,e,a)=>{a.d(e,{A:()=>n});var r=a(14317);async function n({actorId:t,actorEmail:e,action:a,targetType:n,targetId:o,metadata:i,ipAddress:s}){let d=(0,r.G)();await d.from("audit_log").insert({actor_id:t,actor_email:e,action:a,target_type:n,target_id:o,metadata:i,ip_address:s})}},7411:(t,e,a)=>{a.d(e,{C:()=>i,p:()=>s});var r=a(82591),n=a(14317);let o=new r.R(process.env.RESEND_API_KEY);async function i({to:t,subject:e,html:a}){let r=Array.isArray(t)?t:[t];await o.emails.send({from:"ApalyRx <noreply@apalyrx.com>",to:r,subject:e,html:a})}async function s(t){let e=(0,n.G)(),{data:a}=await e.from("admin_notification_settings").select("email_list, enabled").eq("event_type",t).single();return a?.enabled&&a.email_list?.length?a.email_list:[]}},39026:(t,e,a)=>{a.d(e,{Df:()=>p,Fo:()=>s,G$:()=>y,Mx:()=>l,WO:()=>i,aS:()=>c,fP:()=>d,iU:()=>h,nh:()=>u,wA:()=>g,xS:()=>m});let r="https://www.apalyrx.com";function n(t){return`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body style="margin:0;padding:0;background:#f4f5f7;font-family:Arial,Helvetica,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f5f7;padding:32px 16px;">
    ...
    `)}}},14317:(t,e,a)=>{a.d(e,{G:()=>n});var r=a(37857);function n(){return(0,r.eI)(process.env.PARTNER_SUPABASE_URL,process.env.PARTNER_SUPABASE_SERVICE_ROLE_KEY)}}};var e=require("../../../../../webpack-runtime.js");e.C(t);var a=t=>e(e.s=t),r=e.X(0,[8948,5972,7857,2591],()=>a(53384));module.exports=r})();