"use strict";(()=>{var t={};t.id=207,t.ids=[207],t.modules={72934:t=>{t.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:t=>{t.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:t=>{t.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:t=>{t.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:t=>{t.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6005:t=>{t.exports=require("node:crypto")},56570:(t,e,a)=>{a.r(e),a.d(e,{originalPathname:()=>x,patchFetch:()=>b,requestAsyncStorage:()=>y,routeModule:()=>g,serverHooks:()=>f,staticGenerationAsyncStorage:()=>h});var r={};a.r(r),a.d(r,{POST:()=>u});var n=a(49303),o=a(88716),i=a(60670),s=a(87070),d=a(14874),p=a(14317),l=a(28218),c=a(7411),m=a(39026);async function u(t){let e=(0,d.C)(),{data:{session:a}}=await e.auth.getSession();if(!a)return s.NextResponse.json({error:"Unauthorized"},{status:401});let{data:r}=await e.from("partner_users").select("id, email, is_apaly_team").eq("user_id",a.user.id).maybeSingle();if(!r?.is_apaly_team)return s.NextResponse.json({error:"Forbidden"},{status:403});let{leadId:n}=await t.json(),o=(0,p.G)(),{data:i}=await o.from("leads").select("id, organization_id, prospect_company_name, status").eq("id",n).single();if(!i||"pending"!==i.status)return s.NextResponse.json({error:"Lead not found or not pending"},{status:400});let{data:u}=await o.from("partner_organizations").select("commission_duration_months, notification_email, company_name").eq("id",i.organization_id).single(),g=u?.commission_duration_months||12,y=new Date,h=new Date(y);h.setDate(h.getDate()+150);let f=new Date(y);if(f.setMonth(f.getMonth()+g),await o.from("leads").update({status:"qualified",qualified_at:y.toISOString(),acceptance_deadline:h.toISOString(),commission_end_date:f.toISOString(),approved_by:r.id,approval_token:null,updated_at:y.toISOString()}).eq("id",n),await o.from("lead_activity").insert({lead_id:n,author_id:r.id,author_type:"apaly_team",content:`Lead approved by ${r.email}. 150-day acceptance window started.`,activity_type:"approval"}),await (0,l.A)({actorId:r.id,actorEmail:r.email,action:"APPROVE_LEAD",targetType:"lead",targetId:n,metadata:{via:"admin_portal"}}),u?.notification_email){let t=(0,m.xS)({companyName:i.prospect_company_name,partnerContactName:u.company_name,deadlineDate:h.toLocaleDateString("en-US",{month:"long",day:"numeric",year:"numeric"}),leadId:n});await (0,c.C)({to:u.notification_email,subject:t.subject,html:t.html}).catch(console.error)}return s.NextResponse.json({success:!0})}let g=new n.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/partners/api/admin/leads/approve/route",pathname:"/partners/api/admin/leads/approve",filename:"route",bundlePath:"app/partners/api/admin/leads/approve/route"},resolvedPagePath:"C:\\Projects\\apalyrx\\src\\app\\partners\\api\\admin\\leads\\approve\\route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:y,staticGenerationAsyncStorage:h,serverHooks:f}=g,x="/partners/api/admin/leads/approve/route";function b(){return(0,i.patchFetch)({serverHooks:f,staticGenerationAsyncStorage:h})}},28218:(t,e,a)=>{a.d(e,{A:()=>n});var r=a(14317);async function n({actorId:t,actorEmail:e,action:a,targetType:n,targetId:o,metadata:i,ipAddress:s}){let d=(0,r.G)();await d.from("audit_log").insert({actor_id:t,actor_email:e,action:a,target_type:n,target_id:o,metadata:i,ip_address:s})}},7411:(t,e,a)=>{a.d(e,{C:()=>i,p:()=>s});var r=a(82591),n=a(14317);let o=new r.R(process.env.RESEND_API_KEY);async function i({to:t,subject:e,html:a}){let r=Array.isArray(t)?t:[t];await o.emails.send({from:"ApalyRx <noreply@apalyrx.com>",to:r,subject:e,html:a})}async function s(t){let e=(0,n.G)(),{data:a}=await e.from("admin_notification_settings").select("email_list, enabled").eq("event_type",t).single();return a?.enabled&&a.email_list?.length?a.email_list:[]}},39026:(t,e,a)=>{a.d(e,{Df:()=>p,Fo:()=>s,G$:()=>y,Mx:()=>l,WO:()=>i,aS:()=>c,fP:()=>d,iU:()=>g,nh:()=>h,wA:()=>u,xS:()=>m});let r="https://www.apalyrx.com";function n(t){return`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
